 ...
 */
package com.situ.reiz.interceptor;
...
public class ShopLoginInterceptor extends HandlerInterceptorAdapter implements Serializable {
	...
	private static final String PAGE_LOGIN = "login_register";
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		Object object = session.getAttribute(ConfigUtils.SESSION_USER_LOGIN);
		if (object == null) {
			// 如果是AJAX的请求
